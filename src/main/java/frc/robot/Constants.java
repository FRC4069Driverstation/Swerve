...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(187.8-0); //-2
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(148.0-0); //-2

    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 7; 
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 8; 
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 12;
    public static final int BACK_LEFT_MODULE_SPEED_ENCODER = 16;   
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(205.5-0); //+4
